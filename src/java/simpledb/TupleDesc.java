...
public class TupleDesc implements Serializable {
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        // some code goes here
        if (i >= numFields())
            throw new NoSuchElementException("No field name at " + i);

        String name = tdItems.get(i).fieldName;
    ...
    public Type getFieldType(int i) throws NoSuchElementException {
        // some code goes here
        if (i >= numFields())
            throw new NoSuchElementException("No field type at " + i);
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("No matched field name: " + name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (tp.numFields() != numFields())
            return false;

        for (int i = 0; i < numFields(); i++)
            if (tp.getFieldType(i) != getFieldType(i))
                return false;
        return true;
    }
